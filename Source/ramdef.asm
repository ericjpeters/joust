...
;WPIA00   EQU     $C804   ;A INPUT                WIDGET-BRD INPUTS;
;WPIA01  EQU     $C805   ;A CONTROL      GAME CNTRLS, PLYR1 AND 2 STARTS
;WPIA_Sound   EQU     $C806   ;B INPUT
;WPIA11  EQU     $C807   ;B CONTROL

;PIAA    EQU     $C80C   ;COIN DOOR,INTERRUPT,SOUND BRD PIA'S
;CPIA00   EQU     $C80D   ;16MS CONTROL - CA1
;PIAB    EQU     $C80E   ;SOUND BOARD OUTPUTS
;CPIA_Sound   EQU     $C80F   ;4MS CONTROL - CB1      B0=1 ENABLE  B0=0 DISABLE
...
ProcessRamLength    EQU     43                                                  ;NUMBER OF PROCESSES RAM BYTES
ProcessRam          RMB     ProcessRamLength                                    ;PROCESSES  EXCLUSIVE RAM
...
;*
;******************************************************************************
                    ORG     ProcessRam                                          ; NEW OFFSETS FROM PROCESSES RAM
...
;*
DYNADJ                  ;START OF DYNAMIC GAME ADJUSTMENTS
...
DYNEND                  ;END OF DYNAMIC GAME ADJUSTS
;*
