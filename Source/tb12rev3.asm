...
.21S    LDX     XSAVE_,Y                                                        ;;Fixme was: 21$ LDX  .XSAVE,Y
        ...
        STB     PIA_ControlB  ;AND GIVE IT TO IT
        LDB     PIA_InputA    ;READ THE SWITCH INPUTS
...
ENTI2   PSHS    B
        ...
        STB     PIA_ControlB
        PULS    B
        CMPB    PIA_InputA    ;IS THE SAME SWITCH STILL PRESSED
...
LTRT    LDA     PIA00
        ...
        JMP     ,U
.3S     LDA     PIA_InputA    ;READ THE SWITCH                                        ;;Fixme was: 3$
        ANDA    #$03    ;ONLY NEED LEFT OR RIGHT
        JSR     WAIT
        CMPA    PIA_InputA    ;IS THE SAME SWITCH STILL PRESSED
        BNE     LTRT
        TSTA
        BEQ     LTRT
        LSRA            ;SHIFT IT
