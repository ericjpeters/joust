...
LOWRAM  EQU     $9C00
;;DMAFIX        EQU     $0404   ;INVERTED DMA'S                                 ;;Double defined symbol
RAM     EQU     RAMALS
...
SOUND   EQU     PIA_Sound   ;SOUND SIDE OF PIA
RED     EQU     $55
GREEN   EQU     $77
...
PIA_Sound                   EQU         $C80E       ; B. SIDE OF THE COIN DOOR PIA
                                                ; * B0-B5 SOUND
                                                ; * B6-B7 LED 0,1
...
PIA_InputA              EQU         $C804       ; A. SIDE OF THE WIDGET (STARGATE STYLE WIDGET)
...
PIA_ControlA            EQU         $C805       ; A. SIDE OF THE WIDGET (STARGATE STYLE WIDGET)

PIA_InputB              EQU         $C806       ; B. SIDE OF THE WIDGET
                                                ; * B0    PLAYER 2 MOVE LEFT
                                                ; * B1    PLAYER 2 MOVE RIGHT
                                                ; * B7    INPUT 1=COCKTAIL

PIA_ControlB            EQU         $C807       ; B. SIDE OF THE WIDGET
...
CURLET  EQU     1       ;CURRENT LETTER POINTER INTO BUFFER                     ;;Fixme was: .CURLET
STCHR   EQU     2       ;THE FIRST CHARACTER OF THE CHARACTER SET               ;;Fixme was: .STCHR
NDCHR   EQU     3       ;THE LAST CHARACTER OF THE CHARACTER SET                ;;Fixme was: .NDCHR
SIDE    EQU     4       ;THE CONTROL BYTE FOR THE WIDGET (UP=$3C , CT=$34)      ;;Fixme was: .SIDE
COLOR   EQU     5       ;THE COLOR TO WRITE THE SCREEN ECHO IN                  ;;Fixme was: .COLOR
WAKUP   EQU     6       ;THE WAKE UP ADDRESS OF THE SLEEP (BECAUSE OF DUAL USE) ;;Fixme was: .WAKUP
XSAVE_  EQU     8       ;THE STARTING POSITION OF THE LINE TO BE INPUTED        ;;Fixme was: .XSAVE     (Got duplicate symbol error for XSAVE, adding underscore after symbol)
CURPOS  EQU     10      ;THE CURRENT CALCULATED CURSOR POSITION                 ;;Fixme was: .CURPOS
RETURN  EQU     12      ;RETURN ADDRESS                                         ;;Fixme was: .RETURN
DEBONC  EQU     14      ;THE CURRENT DEBOUNCE TIME ON THE ENTER SWITCH          ;;Fixme was: .DEBONC
CARAC   EQU     15      ;THE START OF THE CHARACTER BUFFER                      ;;Fixme was: .CARAC
